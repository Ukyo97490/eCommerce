    ...
    <ul class="nav">
        <li class="nav-item">
            <a class="nav-link" href="index.html">
                ...
                <span class="menu-title">Panneau d'Administration</span>
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="category">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/category/create') }}">Ajouter une
                            catégorie</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/category') }}">Voir les
                            catégories</a></li>
                </ul>
            </div>
        </li>
